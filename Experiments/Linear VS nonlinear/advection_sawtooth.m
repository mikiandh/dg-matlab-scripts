...
% equation as a function of time, using a triangular initial condition.

%% Setup
fileNameRoot = 'advection_sawtooth';
...
exactSolution = @(t,x) advectionExact(t,x,@(x) 1 - abs(x),1,[-1,1]);
